<footer class="main-footer">
    <div class="footer-left">
        Copyright &copy; 2024 <div class="bullet"></div> Design By <a
            href="https://www.instagram.com/__fauzan114/">Fzn</a>
    </div>
...
<script src="{{ asset('assets/admin/modules/bootstrap/js/bootstrap.bundle.js') }}"></script>
...
<script src="{{ asset('assets/admin/js/page/features-posts.js') }}"></script>
