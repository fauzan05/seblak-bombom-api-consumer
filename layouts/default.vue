                        ...
                        <div class="hidden md:flex items-center space-x-6">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="relative notif-wrapper h-20 flex items-center" @mouseenter="isNotifOpen = true"
                                    ...
                                    <div v-show="isNotifOpen"
                                        ...
                                        <div class="space-y-3">
                                            <div class="p-3 hover:bg-orange-50 rounded-lg transition-colors cursor-pointer">
                                                <div class="flex items-start">
                                                    <div
                            ...
                            <div class="relative cart-wrapper flex items-center h-20" @mouseenter="isCartOpen = true"
                                ...
                                <button @click.stop="toggleCart"
                                    ...
                                    <span
                                        class="absolute top-4 -right-1 bg-red-500 text-white text-[10px] rounded-full h-5 w-5 flex items-center justify-center">
                                        3
                                    </span>
                                </button>
                                <!-- Cart Dropdown -->
                    ...
                    <div class="flex items-center justify-between p-4">
                        ...
                        <div class="flex items-center space-x-3">
                            <div v-if="currentUser">
                                <svg width="100" height="100" class="h-10 w-10 rounded-full bg-white border border-gray-200"
                                    viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="50" cy="50" r="48" fill="#F3F4F6" stroke="#E5E7EB" stroke-width="4" />
